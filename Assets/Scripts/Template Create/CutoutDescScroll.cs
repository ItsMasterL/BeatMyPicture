...
public class CutoutDescScroll : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        buttons = GameObject.FindGameObjectsWithTag("PoseDescCutout");
        ...
        GetComponent<Scrollbar>().numberOfSteps = (buttons.Length - 1) * 150;
    }
